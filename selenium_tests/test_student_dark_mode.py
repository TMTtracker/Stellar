"""
Student night mode test - logs in as a student, opens the Dashboard's
Settings dropdown, toggles Night mode on and confirms it actually switched
(the <html> element gets a "dark" class - see useDarkMode.jsx), then toggles
it back off and confirms that works too.
...
Setup (see selenium_tests/README.md for the full version):
  ...
  4. python selenium_tests/test_student_dark_mode.py
"""
